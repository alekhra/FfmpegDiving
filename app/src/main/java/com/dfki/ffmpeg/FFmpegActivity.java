...
public class FFmpegActivity extends MainActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(FFmpegActivity.this);
            ...
            public void onClick(View v) {
                ...
                if (video_url != null) {
                    ...
                    try {
                        ...
                        Toast.makeText(FFmpegActivity.this, e.toString(), Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    }
                } else
                    Toast.makeText(FFmpegActivity.this, "Please upload video", Toast.LENGTH_SHORT).show();
            }
        });
        fast.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (video_url != null) {
                    ...
                    Toast.makeText(FFmpegActivity.this, "Please select video", Toast.LENGTH_SHORT).show();
            }
        });
